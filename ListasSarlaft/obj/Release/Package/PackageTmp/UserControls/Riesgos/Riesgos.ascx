                        ...
                        <tr>
                            <td>
                                <asp:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="0" Font-Names="Calibri"
                                    ...
                                    <asp:TabPanel ID="TabActivos" runat="server" HeaderText="Activos" Font-Names="Calibri"
                                        Font-Size="Small">
                                        <HeaderTemplate>
                                            Activos
                                        </HeaderTemplate>
                                        <ContentTemplate>
                                            <table>
                                                <tr align="center">
                                                    <td>
                                                        <table id="tbGridActivos" runat="server">
                                                            <tr align="left">
                                                                <td bgcolor="#BBBBBB">
                                                                    <asp:Label ID="Label95" runat="server" Text="Nombre del Riesgo:" Font-Names="Calibri"
                                                                        Font-Size="Small"></asp:Label>
                                                                </td>
                                                                <td bgcolor="#EEEEEE">
                                                                    <asp:Label ID="Label96" runat="server" Font-Names="Calibri" Font-Size="Small"></asp:Label>
                                                                </td>
                                                            </tr>
                                                            <tr align="center">
                                                                <td bgcolor="#BBBBBB" colspan="2">
                                                                    <asp:Label ID="Label97" runat="server" Font-Names="Calibri" Font-Size="Small" Text="Activos Relacionados"></asp:Label>
                                                                </td>
                                                            </tr>
                                                            <tr align="center">
                                                                <td colspan="2">
                                                                    <table id="tbActivosSel" runat="server">
                                                                        <tr>
                                                                            <td>
                                                                                <asp:GridView ID="gvListActivosvsRiesgo" runat="server" AllowPaging="True" AllowSorting="True"
                                                                                    ...
                                                                                    Font-Bold="False"
                                                                                    ShowHeaderWhenEmpty="True" DataKeyNames="IdActivo">
                                                                                    <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                                                                                    <Columns>

                                                                                        <asp:BoundField DataField="NombreActivo" HeaderText="Nombre del Activo" ItemStyle-HorizontalAlign="Center"></asp:BoundField>
                                                                                        <asp:BoundField DataField="NombreTipoActivo" HeaderText="Tipo del Activo" ItemStyle-HorizontalAlign="Center"></asp:BoundField>
                                                                                        <%--<asp:BoundField DataField="Descripcion" HeaderText="Descripcion" ItemStyle-HorizontalAlign="Center"
                                                                                            ItemStyle-Wrap="true" ItemStyle-Width="250"></asp:BoundField>--%>
                                    ...
                                    <ItemTemplate>
                                        <div style="overflow: hidden; text-overflow: ellipsis; width:450px;">
                                           <%-- <asp:Label ID="lblDescripcion" Style="word-wrap: normal; word-break: break-all;" runat="server" Text='<% # Bind("Descripcion")%>'></asp:Label>--%>
                                            <asp:TextBox ID="txtDescripcion" TextMode="MultiLine"
           Rows="5"  runat="server" Text='<% # Bind("Descripcion")%>' Enabled="false" Width="100%" Wrap="true"/>
                                        </div>
                                    </ItemTemplate>
                                    ...
                                    <ItemStyle Wrap="false" />
                                                                        ...
                                                                        <tr>
                                                                            <td align="right">
                                                                                <asp:ImageButton ID="imgAddActivo" runat="server" ToolTip="Insertar" ImageUrl="~/Imagenes/Icons/Add.png"
                                                                                    OnClick="imgAddActivo_Click"></asp:ImageButton>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                            ...
                                            <table id="tbListaActivos" runat="server" visible="false">
                                                <tr align="left">
                                                    <td align="left" bgcolor="#BBBBBB">
                                                        <asp:Label ID="lblActivos" runat="server" CssClass="Apariencia" Text="Activos:"></asp:Label>
                                                    </td>
                                                    <td>
                                                        <asp:CheckBoxList ID="cblActivos" runat="server" Font-Names="Calibri" Font-Size="Small">
                                                        </asp:CheckBoxList>
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        <asp:ImageButton ID="imgRelActivos" runat="server" ImageUrl="~/Imagenes/Icons/guardar.png"
                                                            ToolTip="Guardar" OnClick="imgRelActivos_Click" />
                                                    </td>
                                                </tr>
                                            </table>
                                        </ContentTemplate>
