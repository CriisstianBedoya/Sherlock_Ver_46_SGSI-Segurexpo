                        ...
                        <asp:Menu ID="Menu3" runat="server" DynamicHorizontalOffset="2" Font-Names="Franklin Gothic Medium"
                            ...
                            <Items>
                                ...
                                <asp:MenuItem Text="Auditoría" Value="Auditoría">
                                    ...
                                    <asp:MenuItem Text="Historial" Value="Historial" NavigateUrl="~/Formularios/Auditoria/Admin/AudAdmHistorial.aspx"></asp:MenuItem>
                                ...
                                <asp:MenuItem Text="Riesgos" Value="Riesgos">
                                    <asp:MenuItem Text="Parametrización" Value="Parametrización">
                                        ...
                                        <asp:MenuItem Text="Riesgos" Value="Riesgos">
                                            ...
                                            <asp:MenuItem Text="Gestión Seguridad de la Información" Value="SGSI">
                                               <%-- <asp:MenuItem Text="Activos" Value="Activos">
                                                    
                                                </asp:MenuItem>--%>
                                                <asp:MenuItem Text="Tipo de Activos" Value="ParametrizacionActivos" NavigateUrl="~/Formularios/SGSI/TipoActivos.aspx"></asp:MenuItem>
                                                <asp:MenuItem Text="Clasificación de Activos" Value="ParametrizacionActivos" NavigateUrl="~/Formularios/SGSI/ClasificacionActivos.aspx"></asp:MenuItem>
                                                    <asp:MenuItem Text="Activos" Value="Activos" NavigateUrl="~/Formularios/SGSI/Activos.aspx"></asp:MenuItem>
                                                <asp:MenuItem Text="Premisas" Value="Premisas" NavigateUrl="~/Formularios/SGSI/Premisas.aspx"></asp:MenuItem>
                                ...
                                <asp:MenuItem Text="Sarlaft" Value="Sarlaft">
                                    ...
                                    <asp:MenuItem Text="Conocimiento de cliente" Value="Conocimiento de cliente">
                                        <asp:MenuItem Text="Formulario conocimiento cliente" Value="Formulario conocimiento cliente" NavigateUrl="~/Formularios/Sarlaft/Admin/AdminFormClienteFCC.aspx"></asp:MenuItem>
                                        <asp:MenuItem Text="Consultar cliente" Value="Consultar cliente" NavigateUrl="~/Formularios/Sarlaft/Admin/ConsultarFormClienteFCC.aspx"></asp:MenuItem>
                                    </asp:MenuItem>
                                    <asp:MenuItem Text="Reportes" Value="Reportes">
                                        <asp:MenuItem Text="Reportes de Modificaciones" Value="Reporte Modificaciones" NavigateUrl="~/Formularios/Perfilamiento/ReporteModificaciones.aspx"></asp:MenuItem>
                                ...
                                <%--<asp:MenuItem Text="QA" Value="QA" >
                                    <asp:MenuItem NavigateUrl="~/Formularios/Calidad/RegistroRequerimientos.aspx" Text="Registro de requerimientos" Value="Registro de requerimiento"></asp:MenuItem>
                                    <asp:MenuItem Text="Reporte de estado de requerimientos" Value="Reporte de requerimientos" NavigateUrl="~/Formularios/Calidad/ReporteRequerimientos.aspx"></asp:MenuItem>
                                    <asp:MenuItem Text="Gestión de usuarios" Value="Gestión de usuarios" NavigateUrl="~/Formularios/Calidad/GestionUsuarios.aspx"></asp:MenuItem>
                                    <asp:MenuItem Text="Gestión de requerimientos" Value="Gestión de requerimientos" NavigateUrl="~/Formularios/Calidad/GestionRequerimientos.aspx">
                                    </asp:MenuItem>
                                </asp:MenuItem>--%>
                            </Items>
