...
namespace ListasSarlaft.UserControls.Riesgos.CuadroMando.Consolidado
{
    public partial class Consolidado : System.Web.UI.UserControl
    {
        ...
        public void mtdTableMes(string coorPro, string coorImp)
        {
            ...
            {
                int Iteracion = objFiltros.dtFechaEvoPerfilInicial.Month - 1;
#pragma warning disable CS0219 // La variable 'points' está asignada pero su valor nunca se usa
                int points = 0;
#pragma warning restore CS0219 // La variable 'points' está asignada pero su valor nunca se usa
                int iteracion = 0;
                Regex rex = new Regex("^[0-9]*$");
                foreach (clsDTOCuadroMandoConsolidado objReporte in lstReporte)
                {
        ...
        public void mtdGrafico()
        {
            ...
            dtMes.Columns.Add("Serie");
            dtMes.Columns.Add("Mes");
#pragma warning disable CS0168 // La variable 'row' se ha declarado pero nunca se usa
            DataRow row;
#pragma warning restore CS0168 // La variable 'row' se ha declarado pero nunca se usa
            ...
            if (booResult == true)
            {
                int Iteracion = objFiltros.dtFechaEvoPerfilInicial.Month - 1;
                int points = 0;
#pragma warning disable CS0219 // La variable 'iteracion' está asignada pero su valor nunca se usa
                int iteracion = 0;
#pragma warning restore CS0219 // La variable 'iteracion' está asignada pero su valor nunca se usa
                Regex rex = new Regex("^[0-9]*$");
                foreach (clsDTOCuadroMandoConsolidado objReporte in lstReporte)
                {
                    promedioProbabilidad = Math.Round((Convert.ToDouble(objReporte.intSumatoriaProbabilidad)) / (Convert.ToDouble(objReporte.intNumeroRegistros))).ToString().Trim();
