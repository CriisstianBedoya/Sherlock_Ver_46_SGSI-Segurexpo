...
namespace ListasSarlaft.UserControls.Riesgos
{
    public partial class Reporte : System.Web.UI.UserControl
    {
        ...
        private void loadGridReporteRiesgos()
        {
            ...
            grid.Columns.Add("DescripcionActivo", typeof(string));
            grid.Columns.Add("NombreTipoActivo", typeof(string));
            grid.Columns.Add("NombreClasificacionActivo", typeof(string));
            grid.Columns.Add("Confidencialidad", typeof(string));
            grid.Columns.Add("Integridad", typeof(string));
            grid.Columns.Add("Disponibilidad", typeof(string));
            grid.Columns.Add("Criticidad", typeof(string));
            grid.Columns.Add("UbicacionActivos", typeof(string));
            ...
            if (dtInfo.Rows.Count > 0)
            {
                ...
                for (int rows = 0; rows < dtInfo.Rows.Count; rows++)
                {
                    InfoGridReporteRiesgos.Rows.Add(new Object[] {
                        ...
                        dtInfo.Rows[rows]["DescripcionActivo"].ToString().Trim(),
                        dtInfo.Rows[rows]["NombreTipoActivo"].ToString().Trim(),
                        dtInfo.Rows[rows]["NombreClasificacionActivo"].ToString().Trim(),
                        dtInfo.Rows[rows]["Confidencialidad"].ToString().Trim(),
                        dtInfo.Rows[rows]["Integridad"].ToString().Trim(),
                        dtInfo.Rows[rows]["Disponibilidad"].ToString().Trim(),
                        dtInfo.Rows[rows]["Criticidad"].ToString().Trim(),
                        dtInfo.Rows[rows]["UbicacionActivos"].ToString().Trim()
                        });
                }
