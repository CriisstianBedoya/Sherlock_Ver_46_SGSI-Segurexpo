...
namespace ListasSarlaft.UserControls.Notificaciones
{
    public partial class CorreosDestino : System.Web.UI.UserControl
    {
        ...
        {
#pragma warning disable CS0219 // La variable 'err' está asignada pero su valor nunca se usa
            bool err = false;
#pragma warning restore CS0219 // La variable 'err' está asignada pero su valor nunca se usa
