...
namespace ListasSarlaft.UserControls.Calidad
{
    ...
    {
#pragma warning disable CS0414 // El campo 'ReporteRequerimientos.IdFormulario' está asignado pero su valor nunca se usa
        string IdFormulario = "10001";
#pragma warning restore CS0414 // El campo 'ReporteRequerimientos.IdFormulario' está asignado pero su valor nunca se usa
        clsCuenta cCuenta = new clsCuenta();
        cCuenta ccCuenta = new cCuenta();
        cQA cQa = new cQA();
#pragma warning disable CS0169 // El campo 'ReporteRequerimientos.LastInsertIdCE' nunca se usa
        private static int LastInsertIdCE;
#pragma warning restore CS0169 // El campo 'ReporteRequerimientos.LastInsertIdCE' nunca se usa
