...
namespace ListasSarlaft.UserControls.Calidad
{
    ...
    {
#pragma warning disable CS0414 // El campo 'GestionRequerimientos.IdFormulario' está asignado pero su valor nunca se usa
        string IdFormulario = "10001";
#pragma warning restore CS0414 // El campo 'GestionRequerimientos.IdFormulario' está asignado pero su valor nunca se usa
        ...
        protected void btnImgInsertar_Click(object sender, ImageClickEventArgs e)
        {
            DataTable dtInfo = new DataTable();
            string strErrMsg = string.Empty;
#pragma warning disable CS0168 // La variable 'DDLText' se ha declarado pero nunca se usa
            string DDLText;
#pragma warning restore CS0168 // La variable 'DDLText' se ha declarado pero nunca se usa
