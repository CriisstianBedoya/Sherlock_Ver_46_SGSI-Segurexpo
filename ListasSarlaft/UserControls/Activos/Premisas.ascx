<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="Premisas.ascx.cs"
    Inherits="ListasSarlaft.UserControls.Activos.Premisas" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    ...
    <table align="center">
        ...
        <br />
        <div id="divInsertar" runat="server" visible="true" class="ColumnStyle">
        <table align="center">
            <tr>
                <td >
        ...
        <br />
    <div id="divCampos" runat="server" visible="true" class="ColumnStyle">
        <table align="center" >
            <tr>
                <td align="center" class="RowsText">
                    <asp:Label ID="lblCodigo" runat="server" BackColor="Silver" CssClass="Apariencia" Text="Código:" Width="300px"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td align="center" class="RowsText">
                    <asp:Label ID="lblNombre" runat="server" BackColor="Silver" CssClass="Apariencia" Text="Nombre:" Width="300px"></asp:Label>
                </td>
                <td>
        ...
        <table align="center">
         <tr class="visible">
                     <td align="left" bgcolor="#BBBBBB">
                         <asp:Label ID="lblDescripcion" runat="server" Text="Descripción:" CssClass="Apariencia" Width="120px" align="center"></asp:Label>
                     </td>
                     <td>
                         <asp:TextBox ID="Descripcion" runat="server" Width="800px" CssClass="Apariencia" Height="80px"
