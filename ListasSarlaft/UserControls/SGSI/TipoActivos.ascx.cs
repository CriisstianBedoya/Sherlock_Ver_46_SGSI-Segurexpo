...
{
    public partial class TipoActivos : System.Web.UI.UserControl
    {
        ...
        protected void ImageButton2_Click(object sender, ImageClickEventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    cActivos.agregarTipoActivo(Sanitizer.GetSafeHtmlFragment(TextBox1.Text.Trim()), Session["idUsuario"].ToString());
                    resetValues();
