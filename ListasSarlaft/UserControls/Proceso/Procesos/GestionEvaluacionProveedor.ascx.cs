...
namespace ListasSarlaft.UserControls.Proceso.Procesos
{
    public partial class GestionEvaluacionProveedor : System.Web.UI.UserControl
    {
        ...
        protected void mtdProcessValues()
        {
            ...
            //decimal value = 0;
            decimal total = 0;
#pragma warning disable CS0219 // La variable 'totalPrevious' está asignada pero su valor nunca se usa
            decimal totalPrevious = 0;
#pragma warning restore CS0219 // La variable 'totalPrevious' está asignada pero su valor nunca se usa
