...
namespace ListasSarlaft.UserControls.Gestion
{
    public partial class MenuCMI : System.Web.UI.UserControl
    {
        ...
        String colorHoy;
        String colorCon;
#pragma warning disable CS0414 // El campo 'MenuCMI.Mes' está asignado pero su valor nunca se usa
        String Mes;
#pragma warning restore CS0414 // El campo 'MenuCMI.Mes' está asignado pero su valor nunca se usa
        //String Periodo;
        String FechaMes;
        String FechaAno;
