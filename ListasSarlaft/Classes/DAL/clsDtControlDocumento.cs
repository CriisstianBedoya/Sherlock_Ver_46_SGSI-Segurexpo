...
namespace ListasSarlaft.Classes
{
    public class clsDtControlDocumento : IDisposable
    {
        ...
        public DataTable mtdDownLoadFileData(ref DataTable dtCaracOut, ref string strErrMsg, ref int IdRegistro, string filename)
        {
            ...
            string strConsulta = string.Empty;
            cDataBase cDatabase = new cDataBase();
#pragma warning disable CS0219 // La variable 'boolResult' está asignada pero su valor nunca se usa
            bool boolResult = false;
#pragma warning restore CS0219 // La variable 'boolResult' está asignada pero su valor nunca se usa
            #endregion Vars
            try
            {
